classdef NgISILW_SHADE < ALGORITHM
    ...
    methods
        function main(Algorithm,Problem)
            ...
            [wl_min,t] = Algorithm.ParameterSet();
            ...
            while Algorithm.NotTerminated(Population)
                ...
                if mod(gen,100)==0 || Problem.FE==Problem.maxFE
                    fprintf('%s  generator: %d  bestV：%.4e  window length: %d  number of replace: %d\n',datestr(now,31),...
                        gen,Population.best.objs,length(ngisilw.windows{1}),sum(replace));
                end
            end
